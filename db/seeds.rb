...
mark_scales = MarkScale.create([{ id: 1, name: '6-12 Scale', description: 'Default grading scale for middle and high schools.', is_active: true },
                                { id: 2, name: 'K-5 Scale', description: 'Default grading scale for elementary schools.', is_active: true }])

marks = Mark.create([{ id: 1, title: 'A+', gpa_value: 4.000, breakoff: 99, weighted_gpa_scale: 4.000, mark_scale_id: 1 },
