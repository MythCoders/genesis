...
Genesis::Module.register :attendance do
  name 'Attendance'
  author 'MythCoders'
  author_url 'http://mythcoders.com'
  url '' if respond_to?(:url)
  description 'This is an attendance module for GeneSIS'
  version '0.1.0'
...
ApplicationSetting.populate('sis_attendance_is_enabled', 'true', 'boolean', 'attendance')