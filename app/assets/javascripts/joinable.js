;(function($, window, undefined){
    ...
    ;(function() {
        ...
        if (typeof define === 'function' && define.amd && define.amd.jQuery) {
            define(['jquery-1.11.3.min'], setup);
        } else {
            setup(jQuery);
        }
...
// This ensures they can be easily overridden with developer styles
    ...
    (function( factory ) {
        if (typeof define !== 'undefined' && define.amd) {
            define(['jquery-1.11.3.min'], factory);
    ...
    /* jquery.nicescroll 3.5.4 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */(function(e){"function"===typeof define&&define.amd?define(["jquery-1.11.3.min"],e):e(jQuery)})(function(e){var y=!1,C=!1,J=5E3,K=2E3,x=0,F=["ms","moz","webkit","o"],s=window.requestAnimationFrame||!1,v=window.cancelAnimationFrame||!1;if(!s)for(var L in F){var D=F[L];s||(s=window[D+"RequestAnimationFrame"]);v||(v=window[D+"CancelAnimationFrame"]||window[D+"CancelRequestAnimationFrame"])}var z=window.MutationObserver||window.WebKitMutationObserver||!1,G={zindex:"auto",cursoropacitymin:0,cursoropacitymax:1,cursorcolor:"#424242",
