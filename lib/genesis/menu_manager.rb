...
module Genesis
  module MenuManager
    ...
    class MenuError < StandardError; end #:nodoc:
    ...
    module MenuHelper
      ...
      def render_menu_node(node, project=nil)
        if node.children.present? || !node.child_menus.nil?
          ...
          return content_tag('li',
                             render_single_menu_node(node, caption, url, selected), :class => 'dave')
        end
      end
      ...
      def render_single_menu_node(item, caption, url, selected)
        ...
        if item.icon.blank?
          ...
          link_to(h(caption), url, options) do
            content_tag :em do
              content_tag :i, :class => "fa-fa-#{item.icon} p"
            end
          end
        end
      end
